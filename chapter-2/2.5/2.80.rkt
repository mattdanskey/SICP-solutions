...
(display "tests\n")
;scheme numbers
(eq? #t (=zero? (make-scheme-number 0)))
(eq? #f (=zero? (make-scheme-number 1)))

;rational numbers
(eq? #t (=zero? (make-rational 0 2))) 
(eq? #f (=zero? (make-rational 2 3)))

;complex numbers
(eq? #t (=zero? (make-complex-from-mag-ang 0 0)))
(eq? #t (=zero? (make-complex-from-real-imag 0 0)))
(eq? #f (=zero? (make-complex-from-mag-ang 3 0)))
(eq? #f (=zero? (make-complex-from-real-imag 1 0)))
